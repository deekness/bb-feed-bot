...
class Summarizer:
    ...
    async def daily_recap(self, hourly_summaries: list[dict],
        ...
        user = (
            ...
            "hour. Anything a summary attributes to a SITE RECAP or write-up "
            "of an earlier day belongs to that day — never restate it as "
            "something that happened today.\n"
            "EPISODE RULE: anything the summaries attribute to the TV "
