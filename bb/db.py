...
ALTER TABLE vote_plans ADD COLUMN IF NOT EXISTS said_to TEXT[] NOT NULL DEFAULT '{}';
ALTER TABLE alliances  ADD COLUMN IF NOT EXISTS decayed_at TIMESTAMPTZ NOT NULL DEFAULT now();
ALTER TABLE game_state ADD COLUMN IF NOT EXISTS detail TEXT NOT NULL DEFAULT '';
ALTER TABLE game_state ADD COLUMN IF NOT EXISTS expires_week INT;
ALTER TABLE vote_plans ADD COLUMN IF NOT EXISTS credibility REAL NOT NULL DEFAULT 0.6;
